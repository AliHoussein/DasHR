...
// post Webhook
Router.route('/hook/addcandidate', { where: "server" } )
  .get( function() {
  ...
  console.log("addcandidate post hook called");
  console.log(data);
